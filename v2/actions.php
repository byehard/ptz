...
<html lang="en">
  <head>
    ...
    <title>Акции | Карелавтотранс</title>
     ...
     <div class="row">
        <div class="col-lg-9">
            <div class="row">
              ...
              <h2>Акции</h2><br>
              <h3>Петрозаводск - Санкт-Петербург</h3>
              <p>С 1 марта 2015г. стоимость проезда на маршруте № 965э "Петрозаводск - С-Петербург Экспресс" всего за <b>500</b> <i class="fa fa-rub"></i>. От Пряжи - <b>490</b> <i class="fa fa-rub"></i>., от Олонца - <b>400</b> <i class="fa fa-rub"></i>.</p>
              <h3>Пудож - Петрозаводск</h3>
              <p>C 10 февраля 2015г. стоимость проезда на маршруте "Пудож - Петрозаводск" всего за <b>365</b> <i class="fa fa-rub"></i></p>
              </div>
